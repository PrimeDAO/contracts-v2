...
describe("Seed", function() {
    ...
    const tenETH            = parseUnits("10").toString(); //Not sure if this is correct
    ...
    describe("» creator is avatar", () => {
        before("!! deploy setup", async () => {
            ...
            softCap        = parseUnits("10").toString();
        ...
        describe("# claim", () => {
            describe("» generics", () => {
                ...
                it("funds dao with fee", async () => {
                    expect((await seedToken.balanceOf(setup.organization.avatar.address)).toString()).to.equal(
                        feeAmount.toString()
                    );
                });
            ...
            context("» claim after vesting duration", async () => {
                ...
                it("claims all seeds after vesting duration", async () => {
                    ...
                    setup.data.prevBalance = await seedToken.balanceOf(setup.organization.avatar.address);
